...
foreach ($files as $file) {
  ...
  $despre = '<section tabindex="0" role="document" aria-label="Despre" id="despre">'.$parsedown->text(file_get_contents('content/_extra/Despre.md')).' <form method="POST" action="https://www.formrocket.me/api/forms/46656298/blog/51662581323500320/post/showSuccessMessageOnDone?message="Mulțumesc pentru interesul tău și pentru completarea formularului! Poți închide această pagină de confirmare.""><p><input type="text" name="nume" placeholder="Nume" aria-required="true" required></p><p><input type="email" name="email" placeholder="Email" aria-required="true" required></p> <p><textarea name="mesaj" rows="4" placeholder="Propunerea/Întrebarea/Comentariul tău aici" aria-required="true" required></textarea></p><p><input type="submit" value="Trimite"></p></form></section>';
}
?>
<!DOCTYPE html>
<html lang="ro">
