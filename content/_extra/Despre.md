...
-  **nu are tracker-e sau reclame** (acest lucru nu se va schimba niciodată);
 - funcționează și fără CSS, dar oricum am doar în jur de 500 de linii (formatate) de CSS pentru întreg blog-ul, deci [dacă crezi că CSS-ul nu se merită, accesează acest site](https://browsehappy.com);
 ...
 - proiectul este realizat sub licența [*CC BY-NC 4.0*](https://creativecommons.org/licenses/by-nc/4.0/deed.ro), deci **poți să îmi copiezi tot site-ul cât timp respecți câteva reguli**, [vezi codul sursă și mai multe informații aici](https://github.com/sabinM1/blog);
